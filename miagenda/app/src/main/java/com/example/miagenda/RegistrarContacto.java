...
import com.example.miagenda.clases.ConexionSQLite;
...
public class RegistrarContacto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Asignar evento click a cada uno de los botones
    ...
    private void registrar(){
        try {
            ...
            miBaseDatos.close();
            Toast.makeText(RegistrarContacto.this,"Datos Registrado con exito", Toast.LENGTH_LONG).show();
